...
export default function Textarea(props) {
  ...
  return (
    <div className="relative w-full">
      <textarea
        className={clsx(
          "peer h-full w-full rounded-md border bg-transparent px-3 py-3 text-base font-normal outline outline-0 transition-all placeholder-shown:border focus:border-2 focus:outline-0  disabled:bg-blue-gray-50 placeholder-shown:placeholder:text-transparent placeholder-shown:focus:placeholder:text-blue-gray-100",
          error
