...
export default function Input(props) {
  ...
  return (
    <div className="relative h-12 w-full">
      <input
        className={clsx(
          "peer h-full w-full rounded-md border bg-transparent px-3 py-3 text-base font-normal outline outline-0 transition-all placeholder-shown:border  focus:outline-0  disabled:bg-blue-gray-50 placeholder-shown:placeholder:text-transparent placeholder-shown:focus:placeholder:text-inherit placeholder-shown:focus:placeholder:opacity-50",
          error
            ? "border-red-200 text-red-700 focus:border-red-500 placeholder-shown:border-red-200 placeholder-shown:border-t-red-200"
            : "border-blue-gray-200 text-inherit focus:border-blue-500 placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200",
        ...
        <label
          className={clsx(
            ...
            error
              ...
              : "before:border-blue-gray-200 after:border-blue-gray-200 peer-focus:before:border-blue-500 peer-focus:after:border-blue-500 text-inherit  peer-focus:text-blue-500"
          )}
          htmlFor="name"
        >
          {label}
